...
// Nombre de points dans l'ensemble
#define NB_POINTS 10000

// Point à 3 dimensions
typedef struct
{
    double x1;
    double x2;
...
// Initialiser les centres des classes par des points aléatoires de l'ensemble des points
...
// Tous les points n'ont pas de classes
...
// Calculer à quelle classe appartient un point (par le calcul de la distance)
...
// Vérifier la stabilité des classes
